...
if(app_mode=="Home"):
    st.markdown('''
    <style>
        .stAppViewMain main st-emotion-cache-bm2z3a ea3mdgi8{
            position: absolute;
            top: 0;
            left: 0;
            width: 100%;
    ...
    <video class="stAppViewMain main st-emotion-cache-bm2z3a ea3mdgi8" autoplay loop muted>
        <source src='https://media.istockphoto.com/id/1033750874/video/capture-the-moving-moment-of-siamese-fighting-fish-group-of-betta-fish-on-black-background.mp4?s=mp4-640x640-is&k=20&c=xXOfzW8K8ExdvuYkuz9jfwN0rGdolKa45QXS48Q-Am4=' type="video/mp4">
    </video>
...
#About Project
    ...
    st.markdown('''
    <style>
        .stAppViewBlockContainer block-container st-emotion-cache-13ln4jf ea3mdgi5{
            position: absolute;
            top: 0;
            left: 0;
            width: 100%;
    ...
    <video class="stAppViewBlockContainer block-container st-emotion-cache-13ln4jf ea3mdgi5" autoplay loop muted>
        <source src='https://media.istockphoto.com/id/1295430901/video/siamese-fighting-fish.mp4?s=mp4-640x640-is&k=20&c=5k08_eZo_yjpSmRV_yjeTFwneBiS4LttspG9mizJDH0=' type="video/mp4">
    </video>
''',unsafe_allow_html=True)
    st.header("About Us")
    st.markdown("""
                #### About Dataset
                This dataset is recreated using offline augmentation from the original dataset.The original dataset can be found on the roboflow.
                This dataset consists of about 8.3K rgb images of healthy and diseased crop leaves which is categorized into 4 different classes.The total dataset is divided into 80/20 ratio of training and validation set preserving the directory structure.
                A new directory containing 33 test images is created later for prediction purpose.
                #### Content
                1. train (8317 images)
                2. test (79 images)
                3. validation (79 images)
